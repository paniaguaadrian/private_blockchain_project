class BlockchainController {
  ...
  //  GET Testing => Route to know everything is working
  getLandingPage() {
  ...
  //   Enpoint to Get a Block by Height
  getBlockByHeight() {
  ...
  //   Endpoint that allows user to request Ownership of a Wallet address
  requestOwnership() {
  ...
  // ! POST         /submitStar
  //   Endpoint that allow Submit a Star, you need first to `requestOwnership` to have the message
  submitStar() {
  ...
  // ! GET          /block/hash/:hash
  // This endpoint allows you to retrieve the block by hash
  getBlockByHash() {
